...
int main(int argc, char *argv[])
{
  ...
  vec<str> sample;
  sample.push_back("B$ L# B$ L\" B+ v\" v\" B* I$ I# v8");
  sample.push_back("B$ L\" B+ v\" v\" B* I$ I#");
  sample.push_back("B+ B* I$ I# B* I$ I#");
  sample.push_back("B+ I' B* I$ I#");
  sample.push_back("B+ I' I'");
  sample.push_back("I-");
